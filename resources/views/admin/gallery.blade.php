                ...
                <div class="content">
                    ...
                    <div class="container-fluid">                        
                        <div class="row">
                            <div class="col-md-12">
                                <div>
                                    <h4 class="header-title mb-3">Add Gallery Images (N:B Upload time varies due to image size and quantity)</h4>
                               ...
                               <form method="post" action="{{route('admin-gallery.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="custom-file-picker">
                                                <div class="picture-container form-group">
                                                    <h4 class="info_text">Click to upload Gallery image</h4>
                                                    <div class="picture">
